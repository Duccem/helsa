...
export default function PasswordChangedEmail({ userName }: PasswordChangedEmailProps) {
  return (
    <Html>
      <Head />
      <Body style={main}>
        <Preview>Your Helsa password was changed</Preview>
        <Container style={container}>
          <Section style={coverSection}>
            ...
            <Section style={upperSection}>
              ...
              <Text style={mainText}>
                {userName ? `Hi ${userName}, ` : ""}this is a confirmation that the password for your Helsa account was
                successfully changed.
              </Text>
              <Text style={text}>
                If you did not make this change, please reset your password immediately and secure your account.
              </Text>
            ...
            <Section style={lowerSection}>
              <Text style={cautionText}>
                ...
                <Link href="mailto:support@helsa.com" style={link}>
                  support@helsa.com
                </Link>
                .
              </Text>
